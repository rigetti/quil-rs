...
#[cfg_attr(
    feature = "stubs",
    gen_stub_pyfunction(module = "quil._quil.expression")
)]
#[pyfunction]
...
pub(crate) fn quil_cos(expression: ExpressionLike) -> FunctionCallExpression {
    FunctionCallExpression::new(
        ExpressionFunction::Cosine,
        ArcIntern::new(expression.into()),
    )
}
