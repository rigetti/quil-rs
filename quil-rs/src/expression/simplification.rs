...
static RULES: Lazy<Vec<Rewrite>> = Lazy::new(|| {
    vec![
        ...
        rw!("neg sub"       ; "(- (neg ?a) ?b)"         => "(neg (+ ?a ?b))"),
        rw!("sub add"       ; "(- ?a (+ ?b ?c))"        => "(- (- ?a ?b) ?c)"),
        rw!("sub add 2"     ; "(- (+ ?a ?b) ?c)"        => "(+ (- ?a ?c) ?b)"),
        rw!("sub add 3"     ; "(- (+ ?a ?b) ?c)"        => "(+ (- ?b ?c) ?a)"),
        rw!("add sub"       ; "(+ ?a (- ?b ?c))"        => "(- (+ ?a ?b) ?c)"),
        rw!("sub sub"       ; "(- ?a (- ?b ?c))"        => "(- (+ ?a ?c) ?b)"),
        rw!("sub sub 2"     ; "(- (- ?a ?b) ?c)"        => "(- ?a (+ ?b ?c))"),
        ...
        rw!("div mul 3"     ; "(/ (* ?a ?b) ?c)"        => "(* (/ ?a ?c) ?b))" if is_not_zero("?c")),
        rw!("mul div"       ; "(* ?a (/ ?b ?a))"        => "?b" if is_not_zero("?a")),
        rw!("mul div 2"     ; "(* (/ ?b ?a) ?a)"        => "?b" if is_not_zero("?a")),
        rw!("mul div 3"     ; "(* (/ ?a ?b) ?c)"        => "(/ (* ?a ?c) ?b)" if is_not_zero("?b")),
        // + & *
        rw!("add self"      ; "(+ ?a ?a)"               => "(* 2 ?a)"),
        ...
        rw!("add associate" ; "(+ (+ ?a ?b) ?c)"        => "(+ ?a (+ ?b ?c))"),
        rw!("add assoc 2"   ; "(+ ?a (+ ?b ?c))"        => "(+ (+ ?a ?b) ?c)"),
        rw!("mul associate" ; "(* (* ?a ?b) ?c)"        => "(* ?a (* ?b ?c))"),
        rw!("mul assoc 2"   ; "(* ?a (* ?b ?c))"        => "(* (* ?a ?b) ?c)"),
        // - & *
        rw!("mul sub"       ; "(* (- ?a ?b) ?c)"        => "(- (* ?a ?c) (* ?b ?c))"),
        rw!("mul sub 2"     ; "(- (* ?a ?c) (* ?b ?c))" => "(* (- ?a ?b) ?c)"),
        // + & /
...
mod tests {
    ...
    //       huge_eggspression,
    //       &RULES,
    //       runner = egg::Runner::default()
    //           .with_iter_limit(1_000)
    //           .with_node_limit(10_000_000)
    //           .with_time_limit(core::time::Duration::from_secs(60 * 20)),
    //       "(/
    //         (+
    //           (*
    //             6.283185307179586
    ...
    //                   (-
    //                     (+
    //                       (+ (neg 3.141592653589793) (/ (* gamma[0] (neg 1.3670709112264738)) 6.283185307179586))
    //                       (+
    //                         (+
    //                           (neg
    //                             (-
    ...
    //                                       (neg
    //                                         (+
    //                                           (- 1292.2571023206997 (+ (neg 3.141592653589793) (/ (* gamma[0] (neg 1.3670709112264738)) 6.283185307179586)))
    //                                           1293.2884354900702)))
    //                                     (+ (neg 3.141592653589793) (/ (* gamma[0] (neg 1.3670709112264738)) 6.283185307179586)))
    //                                   (+
    //                                     (-
    //                                       1292.2571023206997
    //                                       (+ (/ (+ (neg 3.141592653589793) (* gamma[0] (neg 1.3670709112264738))) 6.283185307179586) 1293.2884354900702))
    //                                     1830.4305845069357))
    //                                 (+
    //                                   (+ 2404.366183299857 (+ (neg 3.141592653589793) (/ (* gamma[0] (neg 1.3670709112264738)) 6.283185307179586)))
    //                                   (+
    //                                     (- 1292.2571023206997 (+ (neg 3.141592653589793) (/ (* gamma[0] (neg 1.3670709112264738)) 6.283185307179586)))
    //                                     1293.2884354900702)))
    //                               2473.4667568746527))
    ...
    //                         2473.4667568746527)
    //                       3654.308518679512)
    //                     (/ (+ (neg 3.141592653589793) (* gamma[0] (neg 1.4598346220303238))) 6.283185307179586))))))
    //           0.4345210910722077)
    //         6.283185307179586)"
    //         => "(+ (* gamma[0] -0.6379644761225252) -14553.919984548365)"
    // }

    //     egg::test_fn! {
    //         next_huge,
    //         &RULES,
    //         runner = egg::Runner::default().with_node_limit(100_000),
    //     "(+
    //   (+
    //     (* gamma[0] -0.6379644761225252)
    //     -14553.989140727886)
    //   0.06915617952182548)"
    //         => "(+ (* gamma[0] -0.6379644761225252) -14553.919984548365)"
    //     }
