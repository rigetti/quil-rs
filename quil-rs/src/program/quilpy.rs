...
create_init_submodule! {
    ...
    classes: [
        ...
        PyCalibrationExpansionSourceMap, // Python: CalibrationExpansionSourceMap
        PyCalibrationExpansionSourceMapEntry, // Python: CalibrationExpansionSourceMapEntry
    ...
    complex_enums: [ CalibrationSource, MaybeCalibrationExpansion ],
    errors: [
        errors::ProgramError,
