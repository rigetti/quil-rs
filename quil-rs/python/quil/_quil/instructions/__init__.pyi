...
class Arithmetic(Instruction):
    ...
    def left(self) -> MemoryReference:
        ...
        """
    @property
    def op(self) -> ArithmeticOperator: ...
    @property
    def operator(self) -> ArithmeticOperator: ...
    @property
    def right(self) -> ArithmeticOperand:
        r"""
...
class Capture(Instruction):
    ...
    @property
    def nonblocking(self) -> builtins.bool: ...
    @property
    ...
    def __new__(cls, frame: FrameIdentifier, kernel: WaveformInvocation, memory_region: MemoryReference  |  DeclarationAt  |  Declaration  |  tuple[builtins.str, builtins.int], *, blocking: builtins.bool = True, nonblocking: typing.Optional[builtins.bool] = None) -> Capture: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
        """
    def get_qubit_indices(self) -> builtins.set[builtins.int]:
        r"""
...
class Comparison(Instruction):
    ...
    @property
    def right(self) -> ComparisonOperand: ...
    @property
    ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, operator: ComparisonOperator, destination: MemoryReference  |  DeclarationAt  |  Declaration  |  tuple[builtins.str, builtins.int], lhs: MemoryReference  |  DeclarationAt  |  Declaration  |  tuple[builtins.str, builtins.int], rhs: ComparisonOperand  |  builtins.int  |  builtins.float  |  MemoryReference  |  DeclarationAt  |  Declaration) -> Comparison: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
...
class Convert(Instruction):
    ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, destination: MemoryReference  |  DeclarationAt  |  Declaration  |  tuple[builtins.str, builtins.int], source: MemoryReference  |  DeclarationAt  |  Declaration  |  tuple[builtins.str, builtins.int]) -> Convert: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
...
class Delay(Instruction):
    ...
    @property
    def frames(self) -> builtins.list[FrameIdentifier]: ...
    @property
    def qubits(self) -> builtins.list[Qubit]: ...
    def __eq__(self, other: builtins.object, /) -> builtins.bool: ...
    def __getnewargs__(self) -> tuple[builtins.list[builtins.str], builtins.list[Qubit], expression.Expression]: ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, frame_names: typing.Sequence[builtins.str  |  FrameIdentifier], qubits: typing.Sequence[Qubit], duration: _quil.expression.Expression  |  MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex, *, frames: typing.Optional[typing.Sequence[builtins.str  |  FrameIdentifier]] = None) -> Delay: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
...
class Exchange(Instruction):
    ...
    def __getnewargs__(self) -> tuple[MemoryReference, MemoryReference]: ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, left: MemoryReference  |  DeclarationAt  |  Declaration  |  tuple[builtins.str, builtins.int], right: MemoryReference  |  DeclarationAt  |  Declaration  |  tuple[builtins.str, builtins.int]) -> Exchange: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
...
class Load(Instruction):
    ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, destination: MemoryReference  |  DeclarationAt  |  Declaration  |  tuple[builtins.str, builtins.int], source: builtins.str, offset: MemoryReference  |  DeclarationAt  |  Declaration  |  tuple[builtins.str, builtins.int]) -> Load: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
...
class Move(Instruction):
    ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, destination: MemoryReference, source: ArithmeticOperand  |  builtins.int  |  builtins.float  |  MemoryReference  |  DeclarationAt  |  Declaration) -> Move: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
...
class PauliSum:
    ...
    def __new__(cls, terms_or_args: typing.Optional[builtins.list[PauliTerm]  |  builtins.list[builtins.str  |  builtins.int  |  Qubit]] = None, /, terms: typing.Optional[builtins.list[PauliTerm]  |  builtins.list[builtins.str  |  builtins.int  |  Qubit]] = None, arguments: typing.Optional[typing.Sequence[builtins.str  |  builtins.int  |  Qubit]] = None) -> PauliSum:
        ...
        """
    def __pow__(self, exponent: builtins.int, modulo: typing.Optional[typing.Any] = None) -> PauliSum: ...
    ...
    def get_qubits(self) -> builtins.list[builtins.str]:
        r"""
...
class PauliTerm:
    ...
    def __str__(self) -> builtins.str:
        ...
        """
    def __sub__(self, other: typing.Any) -> typing.Any: ...
    def compact_str(self) -> builtins.str:
        r"""
    ...
    def get_qubits(self) -> builtins.list[Qubit]:
        ...
        """
    def id(self, sort_ops: builtins.bool = False, /, delimiter: builtins.str = '') -> builtins.str:
        r"""
    ...
    def operations_as_set(self) -> builtins.frozenset[builtins.tuple[PauliGate, builtins.str]]:
        ...
        """
    def pauli_string(self, qubits: typing.Optional[typing.Sequence[builtins.int]] = None) -> builtins.str:
        r"""
...
class Pragma(Instruction):
    ...
    @property
    def freeform_string(self) -> typing.Optional[builtins.str]: ...
    @property
    def name(self) -> builtins.str: ...
    def __eq__(self, other: builtins.object, /) -> builtins.bool: ...
    def __getnewargs__(self) -> tuple[builtins.str, builtins.list[PragmaArgument], typing.Optional[builtins.str]]: ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, name: builtins.str, args: typing.Sequence[PragmaArgument] = [], data: typing.Optional[builtins.str] = None, *, command: typing.Optional[builtins.str] = None, freeform_string: typing.Optional[builtins.str] = None) -> Pragma:
        r"""
...
class Pulse(Instruction):
    ...
    def __new__(cls, frame: FrameIdentifier, waveform: WaveformInvocation, *, blocking: builtins.bool = True, nonblocking: typing.Optional[builtins.bool] = None) -> Pulse: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
...
class RawCapture(Instruction):
    ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, frame: FrameIdentifier, duration: _quil.expression.Expression  |  MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex, memory_region: MemoryReference  |  DeclarationAt  |  Declaration  |  tuple[builtins.str, builtins.int], *, blocking: builtins.bool = True, nonblocking: typing.Optional[builtins.bool] = None) -> RawCapture: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
...
class Reset(Instruction):
    ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, qubit: typing.Optional[Qubit] = None) -> Reset:
        r"""
    ...
    def __repr__(self) -> builtins.str:
        ...
        [`Debug`](std::fmt::Debug) implementation.
        """
    def get_qubit_indices(self) -> typing.Optional[builtins.set[builtins.int]]:
        r"""
...
class SetFrequency(Instruction):
    ...
    def frame(self) -> FrameIdentifier: ...
    @property
    def freq(self) -> expression.Expression: ...
    @property
    def frequency(self) -> expression.Expression: ...
    def __eq__(self, other: builtins.object, /) -> builtins.bool: ...
    def __getnewargs__(self) -> tuple[FrameIdentifier, expression.Expression]: ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, frame: FrameIdentifier, frequency: _quil.expression.Expression  |  MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex, *, freq: typing.Optional[_quil.expression.Expression  |  MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex] = None) -> SetFrequency: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
...
class SetPhase(Instruction):
    ...
    def __getnewargs__(self) -> tuple[FrameIdentifier, expression.Expression]: ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, frame: FrameIdentifier, phase: _quil.expression.Expression  |  MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex) -> SetPhase: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
...
class SetScale(Instruction):
    ...
    def __getnewargs__(self) -> tuple[FrameIdentifier, expression.Expression]: ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, frame: FrameIdentifier, scale: _quil.expression.Expression  |  MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex) -> SetScale: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
...
class ShiftFrequency(Instruction):
    ...
    def __getnewargs__(self) -> tuple[FrameIdentifier, expression.Expression]: ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, frame: FrameIdentifier, frequency: _quil.expression.Expression  |  MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex, *, freq: typing.Optional[_quil.expression.Expression  |  MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex] = None) -> ShiftFrequency: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
...
class ShiftPhase(Instruction):
    ...
    def __getnewargs__(self) -> tuple[FrameIdentifier, expression.Expression]: ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, frame: FrameIdentifier, phase: _quil.expression.Expression  |  MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex) -> ShiftPhase: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
...
class Store(Instruction):
    ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, destination: builtins.str, offset: MemoryReference  |  DeclarationAt  |  Declaration  |  tuple[builtins.str, builtins.int], source: ArithmeticOperand  |  builtins.int  |  builtins.float  |  MemoryReference  |  DeclarationAt  |  Declaration) -> Store: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
...
class UnaryLogic(Instruction):
    ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, operator: UnaryOperator, operand: MemoryReference  |  DeclarationAt  |  Declaration  |  tuple[builtins.str, builtins.int]) -> UnaryLogic: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
...
class WaveformDefinition(Instruction):
    ...
    def name(self) -> builtins.str: ...
    def __eq__(self, other: builtins.object, /) -> builtins.bool: ...
    def __getnewargs__(self) -> tuple[builtins.str, builtins.list[builtins.str], builtins.list[expression.Expression]]: ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, name: builtins.str, parameters: typing.Sequence[builtins.str], entries: typing.Sequence[expression.Expression]) -> WaveformDefinition: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
        """
    @staticmethod
    def from_waveform(name: builtins.str, definition: Waveform) -> WaveformDefinition:
        r"""
