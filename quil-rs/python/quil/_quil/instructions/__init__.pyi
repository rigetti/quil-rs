...
class PauliTerm:
    ...
    def __eq__(self, other: builtins.object, /) -> builtins.bool: ...
    def __getnewargs__(self) -> tuple[builtins.list[tuple[PauliGate, builtins.str]], expression.Expression]: ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, arguments: typing.Sequence[tuple[PauliGate, builtins.str]], expression: expression.Expression) -> PauliTerm: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
