...
class BuiltinWaveform(typing.Generic[_Real, _Complex]):
    ...
    def evaluate(self, real: abc.collections.abc.Callable[[_Real], _OtherReal], complex: abc.collections.abc.Callable[[_Complex], _OtherComplex]) -> BuiltinWaveform[_OtherReal, _OtherComplex]: ...
...
class CommonBuiltinParameters(typing.Generic[_Real, _Complex]):
    ...
    def __repr__(self) -> builtins.str: ...
    def evaluate(self, real: abc.collections.abc.Callable[[_Real], _OtherReal], complex: abc.collections.abc.Callable[[_Complex], _OtherComplex]) -> CommonBuiltinParameters[_OtherReal, _OtherComplex]: ...
...
class DragGaussian(typing.Generic[_Real, _Complex]):
    ...
    def __repr__(self) -> builtins.str: ...
    def evaluate(self, real: abc.collections.abc.Callable[[_Real], _OtherReal], complex: abc.collections.abc.Callable[[_Complex], _OtherComplex]) -> DragGaussian[_OtherReal, _OtherComplex]: ...
...
class ErfSquare(typing.Generic[_Real, _Complex]):
    ...
    def __repr__(self) -> builtins.str: ...
    def evaluate(self, real: abc.collections.abc.Callable[[_Real], _OtherReal], complex: abc.collections.abc.Callable[[_Complex], _OtherComplex]) -> ErfSquare[_OtherReal, _OtherComplex]: ...
...
class Flat(typing.Generic[_Real, _Complex]):
    ...
    def __repr__(self) -> builtins.str: ...
    def evaluate(self, real: abc.collections.abc.Callable[[_Real], _OtherReal], complex: abc.collections.abc.Callable[[_Complex], _OtherComplex]) -> Flat[_OtherReal, _OtherComplex]: ...
...
class Gaussian(typing.Generic[_Real, _Complex]):
    ...
    def __repr__(self) -> builtins.str: ...
    def evaluate(self, real: abc.collections.abc.Callable[[_Real], _OtherReal], complex: abc.collections.abc.Callable[[_Complex], _OtherComplex]) -> Gaussian[_OtherReal, _OtherComplex]: ...
...
class HermiteGaussian(typing.Generic[_Real, _Complex]):
    ...
    def __repr__(self) -> builtins.str: ...
    def evaluate(self, real: abc.collections.abc.Callable[[_Real], _OtherReal], complex: abc.collections.abc.Callable[[_Complex], _OtherComplex]) -> HermiteGaussian[_OtherReal, _OtherComplex]: ...
...
class Waveform(typing.Generic[_Real, _Complex]):
    ...
    def evaluate(self, real: abc.collections.abc.Callable[[_Real], _OtherReal], complex: abc.collections.abc.Callable[[_Complex], _OtherComplex]) -> Waveform[_OtherReal, _OtherComplex]: ...
    @staticmethod
    ...
    @staticmethod
    def from_quil(invocation: instructions.WaveformInvocation) -> Waveform[quil.expression.Expression, quil.expression.Expression]: ...
    @staticmethod
