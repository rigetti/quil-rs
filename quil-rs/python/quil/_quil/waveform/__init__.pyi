...
class Waveform(typing.Generic[_Real, _Complex]):
    def __eq__(self, other: builtins.object) -> builtins.bool: ...
    def __repr__(self) -> builtins.str: ...
    def as_builtin(self) -> builtins.Optional[builtins.tuple[BuiltinWaveform[_Real, _Complex], CommonBuiltinParameters[_Real, _Complex]]]: ...
    def as_custom(self) -> builtins.Optional[builtins.tuple[builtins.str, builtins.dict[builtins.str, _Complex]]]: ...
    @staticmethod
