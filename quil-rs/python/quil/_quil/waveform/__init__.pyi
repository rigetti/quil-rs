...
class CommonBuiltinParameters(typing.Generic[_Real, _Complex]):
    ...
    @property
    def pad_left(self) -> typing.Optional[builtins.float]: ...
    @pad_left.setter
    def pad_left(self, value: typing.Optional[builtins.float]) -> None: ...
    @property
    def pad_right(self) -> typing.Optional[builtins.float]: ...
    @pad_right.setter
    def pad_right(self, value: typing.Optional[builtins.float]) -> None: ...
    @property
    ...
    def __new__(cls, *, duration: builtins.float, scale: typing.Optional[_Real] = None, phase: typing.Optional[_Real] = None, detuning: typing.Optional[_Real] = None, pad_left: typing.Optional[builtins.float] = None, pad_right: typing.Optional[builtins.float] = None) -> CommonBuiltinParameters[_Real, _Complex]: ...
    def __repr__(self) -> builtins.str: ...
...
class ErfSquare(typing.Generic[_Real, _Complex]):
    ...
    def __eq__(self, other: builtins.object) -> builtins.bool: ...
    def __getnewargs_ex__(self) -> tuple: ...
    def __new__(cls, *, risetime: _Real) -> ErfSquare[_Real, _Complex]: ...
    def __repr__(self) -> builtins.str: ...
...
class ExplicitCommonBuiltinParameters:
    ...
    def detuning(self, value: builtins.float) -> None:
        ...
        """
    @property
    def pad_left(self) -> builtins.int:
        r"""
        Number of zero padding samples to add to beginning of pulse.
        """
    @pad_left.setter
    def pad_left(self, value: builtins.int) -> None:
        r"""
        Number of zero padding samples to add to beginning of pulse.
        """
    @property
    def pad_right(self) -> builtins.int:
        r"""
        Number of zero padding samples to add to end of pulse.
        """
    @pad_right.setter
    def pad_right(self, value: builtins.int) -> None:
        r"""
        Number of zero padding samples to add to end of pulse.
        """
    @property
    ...
    def __eq__(self, other: builtins.object, /) -> builtins.bool: ...
    def __getnewargs_ex__(self) -> tuple: ...
    def __new__(cls, *, sample_count: builtins.int, scale: builtins.float, phase: builtins.float, detuning: builtins.float, pad_left: builtins.int, pad_right: builtins.int) -> ExplicitCommonBuiltinParameters: ...
    def __repr__(self) -> builtins.str: ...
...
class RaisedCosine(typing.Generic[_Real, _Complex]):
    ...
    def __eq__(self, other: builtins.object) -> builtins.bool: ...
    def __getnewargs_ex__(self) -> tuple: ...
    def __new__(cls, *, rolloff: _Real) -> RaisedCosine[_Real, _Complex]: ...
    def __repr__(self) -> builtins.str: ...
...
class Waveform(typing.Generic[_Real, _Complex]):
    ...
    @staticmethod
    def boxcar_kernel(*, duration: builtins.float, scale: typing.Optional[_Real] = None, phase: typing.Optional[_Real] = None, detuning: typing.Optional[_Real] = None, pad_left: typing.Optional[builtins.float] = None, pad_right: typing.Optional[builtins.float] = None) -> Waveform[_Real, _Complex]: ...
    @staticmethod
    ...
    @staticmethod
    def drag_gaussian(*, duration: builtins.float, scale: typing.Optional[_Real] = None, phase: typing.Optional[_Real] = None, detuning: typing.Optional[_Real] = None, pad_left: typing.Optional[builtins.float] = None, pad_right: typing.Optional[builtins.float] = None, fwhm: _Real, t0: _Real, anh: _Real, alpha: _Real) -> Waveform[_Real, _Complex]: ...
    @staticmethod
    def erf_square(*, duration: builtins.float, scale: typing.Optional[_Real] = None, phase: typing.Optional[_Real] = None, detuning: typing.Optional[_Real] = None, pad_left: typing.Optional[builtins.float] = None, pad_right: typing.Optional[builtins.float] = None, risetime: _Real) -> Waveform[_Real, _Complex]: ...
    ...
    @staticmethod
    def flat(*, duration: builtins.float, scale: typing.Optional[_Real] = None, phase: typing.Optional[_Real] = None, detuning: typing.Optional[_Real] = None, pad_left: typing.Optional[builtins.float] = None, pad_right: typing.Optional[builtins.float] = None, iq: _Complex) -> Waveform[_Real, _Complex]: ...
    @staticmethod
    def from_quil(invocation: instructions.WaveformInvocation) -> Waveform[expression.Expression, expression.Expression]: ...
    @staticmethod
    def gaussian(*, duration: builtins.float, scale: typing.Optional[_Real] = None, phase: typing.Optional[_Real] = None, detuning: typing.Optional[_Real] = None, pad_left: typing.Optional[builtins.float] = None, pad_right: typing.Optional[builtins.float] = None, fwhm: _Real, t0: _Real) -> Waveform[_Real, _Complex]: ...
    @staticmethod
    def hermite_gaussian(*, duration: builtins.float, scale: typing.Optional[_Real] = None, phase: typing.Optional[_Real] = None, detuning: typing.Optional[_Real] = None, pad_left: typing.Optional[builtins.float] = None, pad_right: typing.Optional[builtins.float] = None, fwhm: _Real, t0: _Real, anh: _Real, alpha: _Real, second_order_hrm_coeff: _Real) -> Waveform[_Real, _Complex]: ...
    @staticmethod
    def raised_cosine(*, duration: builtins.float, scale: typing.Optional[_Real] = None, phase: typing.Optional[_Real] = None, detuning: typing.Optional[_Real] = None, pad_left: typing.Optional[builtins.float] = None, pad_right: typing.Optional[builtins.float] = None, rolloff: _Real) -> Waveform[_Real, _Complex]: ...
