...
class FrameSet:
    ...
    def __repr__(self) -> builtins.str:
        ...
        [`Debug`](std::fmt::Debug) implementation.
        """
    def get(self, identifier: instructions.FrameIdentifier) -> typing.Optional[builtins.dict[builtins.str, instructions.AttributeValue]]:
        r"""
        Retrieve the `FrameAttributes` of a `Frame` by its `FrameIdentifier`.
        """
    def get_all_frames(self) -> builtins.dict[instructions.FrameIdentifier, builtins.dict[builtins.str, instructions.AttributeValue]]: ...
    def get_keys(self) -> builtins.list[instructions.FrameIdentifier]:
        r"""
        Return a list of all `FrameIdentifier`s described by this `FrameSet`.
        """
    def insert(self, identifier: instructions.FrameIdentifier, attributes: typing.Mapping[builtins.str, instructions.AttributeValue]) -> None:
        r"""
        Insert a new frame by ID, overwriting any existing one.
        """
    def intersection(self, identifiers: builtins.set[instructions.FrameIdentifier]) -> FrameSet:
        r"""
...
class InstructionSourceMap:
    ...
    def list_sources_for_calibration_used(self, calibration_used: CalibrationSource) -> builtins.list[builtins.int]:
        ...
        """
    def list_sources_for_gate_expansion(self, gate_signature: instructions.GateSignature) -> builtins.list[builtins.int]:
        r"""
...
class MemoryRegion:
    @property
    def sharing(self) -> typing.Optional[instructions.Sharing]: ...
    @property
    def size(self) -> instructions.Vector: ...
    def __eq__(self, other: builtins.object, /) -> builtins.bool: ...
    def __getnewargs__(self) -> tuple[instructions.Vector, typing.Optional[instructions.Sharing]]: ...
    def __hash__(self) -> builtins.int: ...
    def __new__(cls, size: instructions.Vector, sharing: typing.Optional[instructions.Sharing]) -> MemoryRegion: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
...
class OwnedDefGateSequenceExpansion:
    ...
    def range(self) -> range:
        ...
        """
    @property
    def source_signature(self) -> instructions.GateSignature:
        r"""
...
class Program:
    ...
    @property
    def circuits(self) -> builtins.dict[builtins.str, instructions.CircuitDefinition]: ...
    @circuits.setter
    def circuits(self, value: typing.Mapping[builtins.str, instructions.CircuitDefinition]) -> None: ...
    @property
    def declarations(self) -> builtins.dict[builtins.str, instructions.Declaration]: ...
    @property
    def frames(self) -> FrameSet: ...
    @frames.setter
    def frames(self, value: FrameSet) -> None: ...
    @property
    def gate_definitions(self) -> builtins.dict[builtins.str, instructions.GateDefinition]: ...
    @gate_definitions.setter
    def gate_definitions(self, value: typing.Mapping[builtins.str, instructions.GateDefinition]) -> None: ...
    @property
    def instructions(self) -> builtins.list[instructions.Instruction]: ...
    @instructions.setter
    def instructions(self, value: typing.Sequence[instructions.Instruction]) -> None: ...
    @property
    ...
    @property
    def waveforms(self) -> builtins.dict[builtins.str, _quil.instructions.Waveform]: ...
    @waveforms.setter
    def waveforms(self, value: typing.Mapping[builtins.str, _quil.instructions.Waveform]) -> None: ...
