...
class Expression:
    ...
    *impossible* to get an owned or `&mut` reference to the child `Expression`s of any `Expression`,
    ...
    def __pow__(self, exponent: Expression  |  instructions.MemoryReference  |  builtins.int  |  builtins.float  |  builtins.complex, modulo: typing.Optional[typing.Any] = None) -> Expression:
        ...
        """
    def __radd__(self, other: Expression  |  instructions.MemoryReference  |  builtins.int  |  builtins.float  |  builtins.complex) -> Expression: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
        """
    def __rmul__(self, other: Expression  |  instructions.MemoryReference  |  builtins.int  |  builtins.float  |  builtins.complex) -> Expression: ...
    def __rpow__(self, base: Expression  |  instructions.MemoryReference  |  builtins.int  |  builtins.float  |  builtins.complex, modulo: typing.Optional[typing.Any] = None) -> Expression: ...
    def __rsub__(self, other: Expression  |  instructions.MemoryReference  |  builtins.int  |  builtins.float  |  builtins.complex) -> Expression: ...
