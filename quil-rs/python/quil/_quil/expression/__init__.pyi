...
ParameterDesignator: TypeAlias = Expression  |  instructions.MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex
...
class Expression:
    ...
    *impossible* to get an owned or `&mut` reference to the child `Expression`s of any `Expression`,
    ...
    """
    def __add__(self, other: Expression  |  instructions.MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex) -> Expression: ...
    ...
    def __mul__(self, other: Expression  |  instructions.MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex) -> Expression: ...
    def __neg__(self) -> Expression: ...
    def __new__(cls, expression: Expression  |  instructions.MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex) -> Expression:
        r"""
    ...
    def __pow__(self, exponent: Expression  |  instructions.MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex, modulo: typing.Optional[typing.Any] = None) -> Expression:
        r"""
        Raise `self` to a complex power.
        
        Note: the `modulo` argument is not supported and will raise an error if provided.
        """
    def __radd__(self, other: Expression  |  instructions.MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex) -> Expression: ...
    def __repr__(self) -> builtins.str:
        r"""
        Implements `__repr__` for Python in terms of the Rust
        [`Debug`](std::fmt::Debug) implementation.
        """
    def __rmul__(self, other: Expression  |  instructions.MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex) -> Expression: ...
    def __rpow__(self, base: Expression  |  instructions.MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex, modulo: typing.Optional[typing.Any] = None) -> Expression: ...
    def __rsub__(self, other: Expression  |  instructions.MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex) -> Expression: ...
    def __rtruediv__(self, other: Expression  |  instructions.MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex) -> Expression: ...
    def __sub__(self, other: Expression  |  instructions.MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex) -> Expression: ...
    def __truediv__(self, other: Expression  |  instructions.MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex) -> Expression: ...
    @typing.overload
    ...
    def substitute(self, d: typing.Optional[typing.Mapping[builtins.str  |  instructions.MemoryReference, builtins.complex  |  typing.Sequence[builtins.complex]]] = None, /) -> Expression  |  builtins.complex:
        ...
        """
    def substitute_variables(self, variable_values: typing.Mapping[builtins.str, Expression  |  instructions.MemoryReference  |  builtins.str  |  builtins.int  |  builtins.float  |  builtins.complex]) -> Expression:
        r"""
