...
class Program:
    ...
    def expand_calibrations_with_source_map(self) -> Tuple["Program", InstructionSourceMap]:
        ...
        """
        ...
    def expand_defgate_sequences(self, /, filter: Optional[FilterStr] = ...) -> "Program":
        ...
        """
        ...
    def expand_defgate_sequences_with_source_map(self, filter: Optional[FilterStr] = ...) -> Tuple["Program", InstructionSourceMap]:
        """Expand any instructions in the program which have a matching sequence gate definition, leaving
...
@final
class DefGateSequenceExpansion:
    def defgate_sequence_source(self) -> GateSignature: ...
...
@final
class FilterStr:
    """A filter for a string, used to match sequence gate definition names during expansion."""
    def as_exclude(self) -> Set[str]: ...
    def as_include(self) -> Set[str]: ...
    @staticmethod
    def from_exclude(inner: Set[str]) -> "FilterStr": ...
    @staticmethod
    def from_include(inner: Set[str]) -> "FilterStr": ...
    def inner(self) -> Set[str]: ...
    def is_exclude(self) -> bool: ...
    def is_include(self) -> bool: ...
    def to_exclude(self) -> Set[str]: ...
    def to_include(self) -> Set[str]: ...
...
class InstructionSourceMapEntry:
    """A source map entry, mapping a range of source instructions by index to a `InstructionTarget`.
