...
class Convert:
    def __new__(cls, original: MemoryReference, to: MemoryReference) -> Self: ...
    @property
    def original(self) -> MemoryReference: ...
    @original.setter
    def original(self, original: MemoryReference): ...
    @property
    def to(self) -> MemoryReference: ...
    @to.setter
    def to(self, to: MemoryReference): ...

class Move:
    def __new__(
        cls, destination: ArithmeticOperand, source: ArithmeticOperand
    ) -> Self: ...
    @property
    def destination(self) -> ArithmeticOperand: ...
    @destination.setter
    def destination(self, destination: ArithmeticOperand): ...
    @property
    def source(self) -> ArithmeticOperand: ...
    @source.setter
...
class Exchange:
    def __new__(cls, left: ArithmeticOperand, right: ArithmeticOperand) -> Self: ...
    @property
    def left(self) -> ArithmeticOperand: ...
    @left.setter
    def left(self, left: ArithmeticOperand): ...
    @property
    def right(self) -> ArithmeticOperand: ...
    @right.setter
    def right(self, right: ArithmeticOperand): ...
