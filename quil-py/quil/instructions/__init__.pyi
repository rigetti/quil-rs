...
class PragmaArgument:
    ...
    def as_integer(self) -> Optional[QubitPlaceholder]: ...
    ...
    @staticmethod
    def from_placeholder(placeholder: QubitPlaceholder) -> "PragmaArgument": ...
    def to_quil(self) -> str:
        """
        Attempt to convert the instruction to a valid Quil string. Raises
        an exception if the instruction can't be converted to valid Quil.
...
class Target:
    ...
    @staticmethod
    def from_fixed(label: str) -> "Target": ...
    @staticmethod
    def from_placeholder(placeholder: TargetPlaceholder) -> "Target": ...
    def is_fixed(self) -> bool: ...
    def is_placeholder(self) -> bool: ...
