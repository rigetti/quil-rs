...
class Instruction:
    ...
    @staticmethod
    def from_jump(jump: Jump) -> "Instruction": ...
    @staticmethod
    def from_jump_when(jump_when: JumpWhen) -> "Instruction": ...
    @staticmethod
    def from_jump_unless(jump_unless: JumpUnless) -> "Instruction": ...
    @staticmethod
    def from_label(label: Label) -> "Instruction": ...
    @staticmethod
...
class Qubit:
    ...
    @staticmethod
    def from_placeholder(placeholder: QubitPlaceholder) -> "Qubit": ...
    def to_quil(self) -> str:
        """
        Attempt to convert the instruction to a valid Quil string. Raises
        an exception if the instruction can't be converted to valid Quil.
...
class Label:
    """
    Represents a Quil label

    Variants:
        ``fixed``: A fixed label defined by a Quil identifier
        ``placeholder``: A placeholder label that can be assigned a new name.
    ...
    def __new__(cls, inner: Union[str, LabelPlaceholder]) -> "Label": ...
    @staticmethod
    def from_fixed(label: str) -> "Label": ...
    @staticmethod
    def from_placeholder(placeholder: LabelPlaceholder) -> "Label": ...
    def is_fixed(self) -> bool: ...
    def is_placeholder(self) -> bool: ...
    def as_fixed(self) -> Optional[str]: ...
    def as_placeholder(self) -> Optional[LabelPlaceholder]: ...
    def to_fixed(self) -> str: ...
    def to_placeholder(self) -> LabelPlaceholder: ...
    def inner(self) -> Union[str, LabelPlaceholder]: ...
    def to_quil(self) -> str:
        """
        Attempt to convert the instruction to a valid Quil string. Raises
        an exception if the instruction can't be converted to valid Quil.
...
class LabelPlaceholder:
    """
    A placeholder label that must be assigned a fixed name before creating a program
    with valid quil.
...
class Jump:
    def __new__(cls, target: Label) -> Self: ...
    @property
    def target(self) -> Label: ...
    @target.setter
    def target(self, target: Label): ...
    def to_quil(self) -> str:
        """
        Attempt to convert the instruction to a valid Quil string. Raises
        an exception if the instruction can't be converted to valid Quil.
...
class JumpWhen:
    def __new__(cls, target: Label, condition: MemoryReference) -> Self: ...
    @property
    def target(self) -> Label: ...
    @target.setter
    def target(self, target: Label): ...
