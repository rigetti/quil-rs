...
class SetFrequency:
    def __new__(
        cls, frame: FrameIdentifier, frequency: Expression
    ) -> "SetFrequency": ...
    @property
    def frame(self) -> FrameIdentifier: ...
    @frame.setter
...
class SetScale:
    def __new__(cls, frame: FrameIdentifier, phase: Expression) -> "SetScale": ...
    @property
    def frame(self) -> FrameIdentifier: ...
    @frame.setter
    def frame(self, frame: FrameIdentifier): ...
...
class SwapPhases:
    def __new__(
        cls, frame_1: FrameIdentifier, frame_2: FrameIdentifier
    ) -> "SwapPhases": ...
    @property
